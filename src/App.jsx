...
export default function App() {
  return (
    <main className="py-20 px-6 nmin-h-svh bg-offwhitebg ">
      <section>
        ...
        <div className="bg-green p-12">
          <img src={iconSuvs} alt="ícones dos carros suvs" className="mb-7" />
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          <img src={iconLuxury} alt="ícones dos carros de luxo" className="mb-7"/>
